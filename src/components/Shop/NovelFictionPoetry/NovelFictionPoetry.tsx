...
const NovelFictionPoetry = ({novelPoetryBooks, handleAddToCart, handleAddToWishlist}) => {
  const [currentIndex, setCurrentIndex] = useState(0);
   const books = Array.isArray(novelPoetryBooks) ? novelPoetryBooks : [];
...
//   }, [books.length]);
  ...
  return (
    <>
     ...
     <section className="novelfictionpoetry  py-8">
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        {/* <i className="fas fa-book-open text-warning mr-2"></i> */}
                        <IoBookSharp size={30} color='#fac309' className='mr-2'/>
                        <h4 className="text-xl font-semibold">গল্প-উপন্যাস-কবিতা</h4>
                    </div>
                    <div>
                        <Link href={`/category/গল্প-উপন্যাস-কবিতা`} className='flex items-center' >
                            <span className='text-black text-sm hover:underline'>সবগুলো দেখুন</span>
                            {/* <i className="fa-solid fa-caret-right text-blue-500 ml-1"></i> */}
                            <IoMdArrowDropright />
...
export default NovelFictionPoetry;
