...
const BBAMBA = ({bbaMbaBooks, handleAddToCart, handleAddToWishlist}) => {
  ...
  const books = Array.isArray(bbaMbaBooks) ? bbaMbaBooks : [];
...
//   }, [books.length]);
  ...
  return (
    <>
      ...
      <section className="bba-mba  py-8">
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        {/* <i className="fas fa-book-open text-warning mr-2"></i> */}
                                 <IoBookSharp size={30} color='#fac309' className='mr-2'/>
                        <h4 className="text-xl font-semibold">বিবিএ-এমবিএ</h4>
                    </div>
                    <div>
                        <Link href={`/category/বিবিএ-এমবিএ`} className='flex items-center'>
