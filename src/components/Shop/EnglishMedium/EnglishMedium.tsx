...
const EnglishMedium = ({ englishMediumBooks, handleAddToCart, handleAddToWishlist }) => {
   const [currentIndex, setCurrentIndex] = useState(0);
   const books = Array.isArray(englishMediumBooks) ? englishMediumBooks : [];
            ...
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        ...
                        <h4 className="text-xl font-semibold">ইংলিশ-মিডিয়াম</h4>
                    </div>
                    <div>
                        <Link href={`/category/ইংলিশ-মিডিয়াম`} className='flex items-center'     >
