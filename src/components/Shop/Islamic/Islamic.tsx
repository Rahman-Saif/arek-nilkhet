...
const Islamic = ({islamicBooks, handleAddToCart, handleAddToWishlist}) => {
  const [currentIndex, setCurrentIndex] = useState(0);
   const books = Array.isArray(islamicBooks) ? islamicBooks : [];
            ...
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        ...
                        <h4 className="text-xl font-semibold">ইসলামিক</h4>
                    </div>
                    <div>
                        <Link href={`/category/ইসলামিক`} className='flex items-center'    >
