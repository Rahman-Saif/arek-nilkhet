...
const MedicalNursing = ({medicalNursingBooks, handleAddToCart, handleAddToWishlist}) => {
  const [currentIndex, setCurrentIndex] = useState(0);
  const books = Array.isArray(medicalNursingBooks) ? medicalNursingBooks : [];
...
const nextSlide = () => {
  ...
  return (
    <>
      ...
      <section className="medicalnursing  py-8">
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        {/* <i className="fas fa-book-open text-warning mr-2"></i> */}
                                 <IoBookSharp size={30} color='#fac309' className='mr-2'/>
                        <h4 className="text-xl font-semibold">মেডিকেল-নার্সিং</h4>
                    </div>
                    <div>
                        <Link href={`/category/মেডিকেল-নার্সিং`} className='flex items-center'>
