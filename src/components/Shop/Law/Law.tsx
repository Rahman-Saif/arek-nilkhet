...
const Law = ({lawBooks, handleAddToCart, handleAddToWishlist}) => {
   const [currentIndex, setCurrentIndex] = useState(0);

  const books = Array.isArray(lawBooks) ? lawBooks : [];
            ...
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        ...
                        <h4 className="text-xl font-semibold">আইন</h4>
                    </div>
                    <div>
                        <Link href={`/category/আইন`} className='flex items-center'  >
