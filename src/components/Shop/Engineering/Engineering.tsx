...
const Engineering = ({engineeringBooks, handleAddToCart, handleAddToWishlist}) => {
  const [currentIndex, setCurrentIndex] = useState(0);
//         const slideInterval=3000;


  const books = Array.isArray(engineeringBooks) ? engineeringBooks : [];
...
//   }, [books.length]);
  ...
  return (
    <>
     ...
     <section className="engineering-slider  py-8">
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        ...
                        <h4 className="text-xl font-semibold">এনজিনিয়ারিং</h4>
                    </div>
                    <div>
                        <Link href={`/category/এনজিনিয়ারিং`} className='flex items-center'>
