...
import './ProgrammingFreelancing.css';
...
const ProgrammingFreelancing = ({programmingBooks, handleAddToCart, handleAddToWishlist}) => {

   const [currentIndex, setCurrentIndex] = useState(0);
   const books = Array.isArray(programmingBooks) ? programmingBooks : [];
            ...
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        ...
                        <h4 className="text-xl font-semibold">প্রোগ্রামিং-ফ্রিল্যান্সিং</h4>
                    </div>
                    <div>
                        <Link href={`/category/প্রোগ্রামিং-ফ্রিল্যান্সিং`} className='flex items-center'     >
...
export default ProgrammingFreelancing;
