...
const Departmental = ({departmentalBooks, handleAddToCart, handleAddToWishlist}) => {

  const [currentIndex, setCurrentIndex] = useState(0);
   const books = Array.isArray(departmentalBooks) ? departmentalBooks : [];
            ...
            <div className="container mx-auto">
                <div className="flex justify-between mb-4">
                    <div className="flex items-center">
                        ...
                        <h4 className="text-xl font-semibold">ডিপার্টমেন্টাল</h4>
                    </div>
                    <div>
                        <Link href={`/category/ডিপার্টমেন্টাল`} className='flex items-center'>
